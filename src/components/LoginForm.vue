<template>
    <!-- Login Form -->
    <div class="text-white text-center font-bold p-5 mb-5"
...
export default {
  ...
  data() {
    return {
      ...
      login_alert_msg: 'Please wait! Login is in progress.',
  ...
  methods: {
    async login(values) {
      ...
      this.login_alert_msg = 'Please wait! Login is in progress.';
      ...
      this.login_alert_msg = "You've been logged in Successfully!";
